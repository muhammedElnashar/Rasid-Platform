...
@section('content')
        ...
        <div class="container">
            ...
            <div class="stats-section">
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        <div class="stats-card">
                            <div class="stats-number">{{ $group->flexible_points ?? 0 }}</div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="card product-card">
                                ...
                                <div class="product-body">
                                    ...
                                    <!-- Exchange Button -->
                                    <button type="button"
                                            class="btn btn-exchange {{ $item->stock <= 0 || ($group->flexible_points ?? 0) < $item->points_required ? 'disabled' : '' }}"
                                            {{ $item->stock <= 0 || ($group->flexible_points ?? 0) < $item->points_required ? 'disabled' : '' }}
                                            onclick="exchangeItem({{ $item->id }}, '{{ $item->name }}', {{ $item->points_required }})">
                                        @if($item->stock <= 0)
                                            <i class="fas fa-ban"></i>
                                            غير متاح
                                        @elseif(($group->flexible_points ?? 0) < $item->points_required)
    ...
    <form id="exchangeForm" action="{{ route('group.exchange') }}" method="POST" style="display:none;">
        @csrf
