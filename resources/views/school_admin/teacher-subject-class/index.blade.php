...
@section('content')
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ route('teacher-subject-classes.create') }}" class="btn btn-primary" style="border-radius: 20px">
                                ...
                                <td>
                                    <div class="d-flex justify-content-center flex-shrink-0">
                                      {{--  <a href="javascript:void(0)"
                                        ...
                                        <!-- زر حذف -->
                                        <form method="POST" action="{{ route('teacher-subject-classes.destroy',$record) }}">
                                            @csrf
                                            @method('DELETE')
    ...
    <!-- Modal with Table -->
{{--
    <div class="modal fade" id="kt_modal_subject_edit" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h2>@lang('message.edit', ['item' => __('message.subject')])</h2>
...
{{--            form.attr('action', '/subjects/' + id);--}}
{{--            form.find('input[name="name"]').val(name);--}}
{{--            var modal = new bootstrap.Modal($('#kt_modal_subject_edit')[0]);--}}
{{--            modal.show();--}}
{{--        });--}}
{{--    </script>--}}
