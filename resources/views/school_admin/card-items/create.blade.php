...
@section('title')
    @lang('message.add', ['item' => __('message.items')])
@endsection
@push("css")
@endpush
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <h1 class="page-heading d-flex text-dark fw-bolder fs-2 flex-column justify-content-center my-0">
                            @lang('message.create', ['item' => __('message.item')])
                        </h1>
                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-body pt-6">
                            <form id="kt_modal_add_form" class="form" method="POST"
                                  action="{{route("cards.categories.items.store",[$card,$category])}}">
                                @csrf
                                ...
                                <div class="fv-row mb-7">
                                    <label class="fs-6 fw-semibold form-label mb-2 ">
                                        <span class="required"> @lang('message.points')</span>
                                    </label>

                                    <div class="input-group input-group-solid mb-5">
                                        <input type="number" value="{{old("points")}}" class="form-control"
                                               name="points"
                                               placeholder="@lang('message.enter', ['item' => __('message.points')])"
                                               autocomplete="off"/>
