...
@section('title')
    @lang('message.list', ['item' => __('message.subjects')])
@endsection
@push("css")
@endpush
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ route('subjects.create') }}" class="btn btn-primary" style="border-radius: 20px">
                                @lang('message.add',['item' => __('message.subject')])</a>
                        </div>
                    </div>
                </div>
