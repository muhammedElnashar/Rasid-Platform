                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-body pt-6">
                            <form id="kt_modal_add_form" class="form" method="POST"
                                  action="{{route("categories.layers.levels.store", [$category, $layer])}}">
                                @csrf
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <div class="input-group input-group-solid mb-5">
                                        <input type="number" min="1" value="{{old("points_required")}}" class="form-control"
                                ...
                                <div class="fv-row mb-7">
                                    <label class="fs-6 fw-semibold form-label mb-2 ">
                                        <span class="required"> قيمة المكافئة</span>
                                    </label>

                                    <div class="input-group input-group-solid mb-5">
                                        <input type="number" min="1" value="{{old("reward_value")}}" class="form-control"
                                               name="reward_value"
                                               placeholder="ادخل قيمة المكافئة"
                                               autocomplete="off"/>
