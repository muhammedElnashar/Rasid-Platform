@extends('layouts.app')
@section('title')
    @lang('message.list', ['item' => __('message.student_class')])
@endsection
@push('css')
                ...
                <div class="card-body pt-0">
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">@lang('message.class')</th>
                        ...
                        @foreach($studentClasses as $studentClass)
                            <tr>
                                <td>{{ $studentClass->student->username }}</td>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center flex-shrink-0">
                                        ...
                                        <a href="javascript:void(0)"
                                           ...
                                           data-student_id="{{ $studentClass->student_id }}"
                                           data-class_id="{{ $studentClass->class_id }}">
                                        ...
                                        {{-- زر حذف --}}
                                        <form method="POST" action="{{ route('student-classes.destroy', $studentClass->id) }}">
                                            @csrf
                                            @method('DELETE')
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h2>@lang('message.edit', ['item' => __('message.student_class')])</h2>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.edit-btn').on('click', function() {
                ...
                form.attr('action', '/student-classes/' + id); // ✅ تعديل الroute
