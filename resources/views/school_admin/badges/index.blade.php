                ...
                <div class="card-body pt-0">
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <tr class=" text-gray-400  fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-100px">النقاط المطلوبة</th>
                            <th class="min-w-50px">الجائزة</th>
                        ...
                        @foreach($badges as $badge)
                            ...
                            <tr>
                                ...
                                <td>{{ $badge->points_awarded }}</td>
                                <td><img src="{{ $badge->image_url }}" alt="{{ $badge->name }}" width="50px" height="50px"></td>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center flex-shrink-0">
                                        <a href="javascript:void(0)"
                                           ...
                                           data-points_awarded="{{ $badge->points_awarded }}"
                                           data-required_points="{{ $badge->required_points }}"
                                        >
                ...
                <form id="editCardForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <div class="mb-5 fv-row">
                            <label class="required fs-5 fw-bold mb-2">الإسم</label>
                        ...
                        <div class="mb-5 fv-row">
                            <label class="required fs-5 fw-bold mb-2">المكافئة</label>
                            <input type="number" min="1" class="form-control form-control-solid" name="points_awarded"/>
                        </div>     <div class="mb-5 fv-row">
                            <label class="required fs-5 fw-bold mb-2">النقاط المطلوبة</label>
                            <input type="number" min="1" class="form-control form-control-solid" name="required_points"/>
                        </div>
                        <div class="mb-5 fv-row">
                            <label class="required fs-5 fw-bold mb-2">الصورة </label>
...
@push("script")
    <script>
        ...
        $('.edit-btn').on('click', function() {
            ...
            var pointsAwarded = $(this).data('points_awarded');
            var requiredPoints = $(this).data('required_points');


            var form = $('#editCardForm');
            form.attr('action', '/badges/' + id);
            form.find('input[name="name"]').val(name);
            form.find('input[name="description"]').val(description);
            form.find('input[name="points_awarded"]').val(pointsAwarded);
            form.find('input[name="required_points"]').val(requiredPoints);
