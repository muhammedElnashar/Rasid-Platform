...
@section('title')
    @lang('message.list', ['item' => __('message.grades')])
@endsection
@push("css")
@endpush
...
@section('content')
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ route('stages.grades.create',$stage) }}" class="btn btn-primary" style="border-radius: 20px">
                                @lang('message.add',['item' => __('message.grade')])</a>
                        </div>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center flex-shrink-0">
                                        <a href="{{route('stages.grades.classes.index',[$stage,$grade])}}" class="btn btn-bg-light btn-active-color-primary btn-sm ms-2">@lang('message.classes')</a>
                                        ...
                                        <!-- زر حذف -->
                                        <form method="POST" action="{{ route('stages.grades.destroy',[$stage,$grade]) }}">
                                            @csrf
                                            @method('DELETE')
    ...
    <!-- Modal with Table -->
    <div class="modal fade" id="kt_modal_grade_edit" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h2>@lang('message.edit', ['item' => __('message.grade')])</h2>
...
@push("script")
    <script>
        ...
        $('.edit-btn').on('click', function() {
            ...
            form.attr('action', '/stages/' + stageId + '/grades/' + id );
            form.find('input[name="name"]').val(name);
            var modal = new bootstrap.Modal($('#kt_modal_grade_edit')[0]);
            modal.show();
        });
    </script>
