...
@section('content')
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center flex-shrink-0">
                                        ...
                                        <!-- زر حذف -->
                                        <form method="POST" action="{{ route('deduction-cards.destroy',$card) }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
    ...
    <div class="modal fade" id="kt_modal_card_deduction_edit" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                ...
                <form id="editCardDeductionForm" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="mb-5 fv-row">
                            <label class="required fs-5 fw-bold mb-2">@lang('message.description')</label>
                        ...
                        <div class="mb-5 fv-row">
                            <label class="required fs-5 fw-bold mb-2">@lang('message.deduction_percent')</label>
                            <input type="number" class="form-control form-control-solid" name="deduction_percent"/>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.edit-btn').on('click', function () {
                ...
                var form = $('#editCardDeductionForm');
                ...
                form.find('select[name="type"]').select2({
                    dropdownParent: $('#kt_modal_card_deduction_edit'),
                    placeholder: form.find('select[name="type"]').data('placeholder'),
                    width: '100%'
                });
                var modal = new bootstrap.Modal($('#kt_modal_card_deduction_edit')[0]);
                modal.show();
            });
