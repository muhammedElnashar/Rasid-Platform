                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ route('recharge-cards.create') }}" class="btn btn-primary">
                                @lang('message.add',['item' => __('message.recharge_cards')])</a>
                        </div>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center flex-shrink-0">
                                        ...
                                        <!-- زر حذف -->
                                        <form method="POST" action="{{ route('recharge-cards.destroy',$card) }}">
                                            @csrf
                                            @method('DELETE')
