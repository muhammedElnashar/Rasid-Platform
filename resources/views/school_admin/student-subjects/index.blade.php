@extends('layouts.app')
@section('title')
    @lang('message.list', ['item' => __('message.student_subject')])
@endsection
@push('css')
...
@section('content')
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ route('student-subjects.create') }}" class="btn btn-primary">
                                @lang('message.add',['item' => __('message.student_subject')])
                            </a>
                        </div>
                    </div>
                </div>
                <div class="card-body pt-0">
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            <th class="min-w-125px">@lang('message.username')</th>
                            <th class="min-w-125px">@lang('message.subject')</th>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center flex-shrink-0">
                                        ...
                                        <a href="javascript:void(0)"
                                           ...
                                           data-id="{{ $studentSubject->id }}"
                                           data-student_id="{{ $studentSubject->student_id }}"
                                           data-subject_id="{{ $studentSubject->subject_id }}">
                                        ...
                                        <form method="POST" action="{{ route('student-subjects.destroy', $studentSubject) }}">
                                            @csrf
                                            @method('DELETE')
    ...
    {{-- Modal Edit --}}
    <div class="modal fade" id="kt_modal_student_class_edit" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h2>@lang('message.edit', ['item' => __('message.student_subject')])</h2>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.edit-btn').on('click', function() {
                ...
                var form = $('#editStudentClassForm');
                form.attr('action', '/student-subjects/' + id); // ✅ تعديل الroute
                ...
                var modal = new bootstrap.Modal($('#kt_modal_student_class_edit')[0]);
                modal.show();
            });
        })
    </script>
