...
<rect opacity="0.3" x="6" y="5" width="6" height="6" rx="3" fill="black"/>
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ Request::routeIs('group-categories.index') || Request::routeIs('group-categories.create')    ?  'active' : '' }}"
                           href="{{ route('group-categories.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            <span class="svg-icon svg-icon-2">
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path opacity="0.3" d="M8.7 16.8L4 18.8999V6.30005L8.7 4.19995V16.8Z" fill="black"/>
                            ...
                            <span class="menu-title fs-5">تصنيفات المجموعات</span>
                        </a>
                    </div>
                    <div class="menu-item">
                        <a class="menu-link {{ Request::routeIs('groups.index') || Request::routeIs('groups.create')    ?  'active' : '' }}"
...
<rect x="3" y="13" width="3" height="6" rx="1.5" fill="black"/>
                            ...
                            <span class="menu-title fs-5">المجموعات</span>
                        </a>
                    </div>
                    <div class="menu-item">
                    ...
                    <div class="menu-item">
                        ...
                        <span class="menu-icon">
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
<path
    d="M21 22H3C2.4 22 2 21.6 2 21V3C2 2.4 2.4 2 3 2H21C21.6 2 22 2.4 22 3V21C22 21.6 21.6 22 21 22ZM18 12C18 11.4 17.6 11 17 11H7C6.4 11 6 11.4 6 12C6 12.6 6.4 13 7 13H17C17.6 13 18 12.6 18 12Z"
    fill="black"/>
</svg>
                            </span>
                            <!--end::Svg Icon-->
...
<path
    ...
    fill="black"/>
                            ...
                            <span class="menu-title fs-5">الاوسمة و الميداليات الصادرة</span>
                        </a>
                    </div>
                    <div class="menu-item">
...
<path d="M15 8H20L14 2V7C14 7.6 14.4 8 15 8Z" fill="black"/>
                    ...
                    <div class="menu-item">
                        ...
                        <span class="menu-icon">
                            ...
                            <span class="svg-icon svg-icon-2">
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path opacity="0.3" d="M15 19H7C5.9 19 5 18.1 5 17V7C5 5.9 5.9 5 7 5H15C16.1 5 17 5.9 17 7V17C17 18.1 16.1 19 15 19Z"
      fill="black"/>
<path
    ...
    fill="black"/>
                            ...
                            <span class="menu-title fs-5">متجر النظام</span>
                        </a>
                    </div>
                    <div class="menu-item">
...
<rect opacity="0.3" x="8" y="3" width="8" height="8" rx="4" fill="black"/>
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ Request::routeIs('children')||Request::routeIs('children.profile')   ?  'active' : '' }}"
                           href="{{ route('children') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            <span class="svg-icon svg-icon-2">
...
<rect opacity="0.3" x="6" y="5" width="6" height="6" rx="3" fill="black"/>
                            ...
                            <span class="menu-title fs-5">ابنائي</span>
                        </a>
                    </div>
                    <div class="menu-item">
...
<path opacity="0.3"
      ...
      fill="black"/>
                            ...
                            <span class="menu-title fs-5">مكافآتي</span>
                        </a>
                    </div>
                    <div class="menu-item">
                        <a class="menu-link {{ Request::routeIs('user.groups') || Request::routeIs('user.group.profile')  ?  'active' : '' }}"
...
<rect x="3" y="13" width="3" height="6" rx="1.5" fill="black"/>
                            ...
                            <span class="menu-title fs-5">مجموعاتي</span>
                        </a>
                    </div>
                    <div class="menu-item">
...
<path d="M18 9H6C5.4 9 5 8.6 5 8C5 7.4 5.4 7 6 7H18C18.6 7 19 7.4 19 8C19 8.6 18.6 9 18 9ZM16 12C16 11.4 15.6 11 15 11H6C5.4 11 5 11.4 5 12C5 12.6 5.4 13 6 13H15C15.6 13 16 12.6 16 12Z" fill="black"/>
                            ...
                            <span class="menu-title fs-5">بطاقات الحسم و الاستبعاد</span>
                        </a>
                    </div>
                    <div class="menu-item">
