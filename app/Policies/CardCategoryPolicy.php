...
{
    protected function hasAccess(User $user, CardCategory $cardCategory): bool
    {
        return ($user->isSchoolAdmin() || $user->isModerator())
            && $user->school_id === $cardCategory->card->school_id;
    }
    ...
    {
        return $this->hasAccess($user, $cardCategory);
    }
